...
def _state_metrics(true_arr: np.ndarray, pred_arr: np.ndarray) -> Dict[str, float]:
    ...
    return {
        ...
        "rmse_theta_dot": Metrics.rmse(td_true, td_pred),
        "r2_theta": Metrics.r2(theta_true, theta_pred),
        "r2_theta_dot": Metrics.r2(td_true, td_pred),
        "rmse": Metrics.rmse(true_arr.ravel(), pred_arr.ravel()),
        "r2": Metrics.r2(true_arr.ravel(), pred_arr.ravel()),
        "fit_pct": Metrics.fit_percent(true_arr.ravel(), pred_arr.ravel()),
    }
